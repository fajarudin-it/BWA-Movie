...
import com.bagicode.bwamovie.checkout.PilihBangkuActivity
import com.bagicode.bwamovie.home.dashboard.PlaysAdapter
import com.bagicode.bwamovie.home.model.Film
import com.bagicode.bwamovie.home.model.Plays
...
class DetilActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_pilih_bangku.setOnClickListener {
            val intent = Intent(this@DetilActivity,
    ...
    private fun getData() {
        mDatabase.addValueEventListener(object : ValueEventListener {
            ...
            override fun onCancelled(error: DatabaseError) {
                Toast.makeText(this@DetilActivity, ""+error.message, Toast.LENGTH_LONG).show()
            }
        })
    }
}
